...
<?= form_open('user/validate_delete_user', $attributes) ?>
...
<div class="delete_user_div">
	...
	<div>
		<button type="submit" class="btn btn-primary pull-right submit submit-btn">Delete User</button>
